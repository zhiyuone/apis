...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CrossVersionObjectReference)(nil), (*scheduling.CrossVersionObjectReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_CrossVersionObjectReference_To_scheduling_CrossVersionObjectReference(a.(*CrossVersionObjectReference), b.(*scheduling.CrossVersionObjectReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*scheduling.CrossVersionObjectReference)(nil), (*CrossVersionObjectReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_scheduling_CrossVersionObjectReference_To_v1beta1_CrossVersionObjectReference(a.(*scheduling.CrossVersionObjectReference), b.(*CrossVersionObjectReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_CrossVersionObjectReference_To_scheduling_CrossVersionObjectReference(in *CrossVersionObjectReference, out *scheduling.CrossVersionObjectReference, s conversion.Scope) error {
...
// Convert_v1beta1_CrossVersionObjectReference_To_scheduling_CrossVersionObjectReference is an autogenerated conversion function.
func Convert_v1beta1_CrossVersionObjectReference_To_scheduling_CrossVersionObjectReference(in *CrossVersionObjectReference, out *scheduling.CrossVersionObjectReference, s conversion.Scope) error {
	return autoConvert_v1beta1_CrossVersionObjectReference_To_scheduling_CrossVersionObjectReference(in, out, s)
}

func autoConvert_scheduling_CrossVersionObjectReference_To_v1beta1_CrossVersionObjectReference(in *scheduling.CrossVersionObjectReference, out *CrossVersionObjectReference, s conversion.Scope) error {
	out.APIVersion = in.APIVersion
	out.Kind = in.Kind
	out.Name = in.Name
	out.Namespace = in.Namespace
...
// Convert_scheduling_CrossVersionObjectReference_To_v1beta1_CrossVersionObjectReference is an autogenerated conversion function.
func Convert_scheduling_CrossVersionObjectReference_To_v1beta1_CrossVersionObjectReference(in *scheduling.CrossVersionObjectReference, out *CrossVersionObjectReference, s conversion.Scope) error {
	return autoConvert_scheduling_CrossVersionObjectReference_To_v1beta1_CrossVersionObjectReference(in, out, s)
}
